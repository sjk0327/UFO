...
<head>
<title> 관리자 공지사항 작성 폼 페이지  - UF&#38;O </title>
													...
													<div class="card">
														...
														<div class="card-block table-border-style">
															<div class="table-responsive">
																	<form name="NoticeInsert" action="/admin/notice/noticeInsert" method="post" >
																<table class="table table-striped table-sm">
																	<tr>
																		<td class="danger" style="font-weight: bold;">작성자</td>
																		<td colspan="5">
																		<input type="text" class="form-control"name="n_name" value="관리자" style="background-color: white;" readonly></td>
																	</tr>
																	<tr>
																		<td class="danger" style="font-weight: bold;">제목</td>
																		<td colspan="5">
																		<input type="text" class="form-control"name="n_title"></td>
																	</tr>
											
																	<tr>
																		<td class="danger" style="font-weight: bold;">글내용</td>
																		<td colspan="5"><textarea name="n_content" class="form-control" rows="18" style="resize: none;"></textarea></td>
																	</tr>
											
																	<tr>
																		<td colspan="7" class="text-center">
																		<input type="submit" value="글작성" class="btn waves-effect waves-light btn-primary btn-outline-primary"> 
																		<input type="button" class="btn waves-effect waves-light btn-primary btn-outline-primary" onclick="location.href='/admin/noticeList'" value="취소"></td>
																	</tr>
																</table>
																</form>
															</div>
