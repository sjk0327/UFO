...
<body>
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><span class="mx-2 mb-0"></span></strong></div>
        </div>
      </div>
    </div>
...
<br>
 ...
 <div class="row">
    		...
    		<form id="form">
           	<span style="margin-left: 3pt;"><button id="button3" href="" class="btn btn-outline-primary" onclick="wishcheckboxArr();">삭제하기</button></span>
...
<span style="float: right;">
            ...
            <span><button id="button3" href="" class="btn btn-outline-primary">위시리스트 비우기</button></span>
     </span>                             
        </div>
