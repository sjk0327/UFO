...
.modal-section{background: #ffffff;box-sizing: border-box;display: none; top: 50%;left: 50%;-webkit-transform: translate(-50%, -50%);-ms-transform: translate(-50%, -50%);-moz-transform: translate(-50%, -50%);-o-transform: translate(-50%, -50%);transform: translate(-50%, -50%);display: none;z-index: 9999;}
								...
								<table border="1" summary="" class="table table-sm table--block">
									...
									<c:set var="buytype" value="${buyInfo.buyType }"></c:set>
											...
											<tr
												...
												<td><img src="/resources/Images/product/${buyInfo.productImg}"
