...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
 <div class="row" >
	 <c:forEach var="list" items="${productList}" begin="0" end="10" step="1" varStatus="status">                      
             <div class="col-sm-6 col-lg-4" id="listClick" onClick="productReadUpdate('${list.p_id}')" data-aos="fade-up" onclick="location.href='/member/pro/productDetail/${list.p_id}'">  
